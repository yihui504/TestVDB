...
- [DEFECT: ILLEGAL_SUCCESS] offset=0 accepted
...
if r.json().get('code') == 0: print(f'[DEFECT: ILLEGAL_SUCCESS] offset=0 accepted'); sys.exit(1)
else: print(f'properly rejected offset=0: {r.json()}'); sys.exit(0)
```
...
- **Initial Run**: [DEFECT: ILLEGAL_SUCCESS] offset=0 accepted
...
Initial Evidence Excerpt: [DEFECT: ILLEGAL_SUCCESS] offset=0 accepted
...
Reproductions:
repro_1
DB URL: http://testvdb-db-d6e43e46e8874081a70d1f655b2742c0:19530
Reason: Observed explicit defect marker.
Evidence Excerpt: [defect: illegal_success] offset=0 accepted
...
repro_2
DB URL: http://testvdb-db-7b6ad1671ea84a3fbde543772ad158d9:19530
Reason: Observed explicit defect marker.
Evidence Excerpt: [defect: illegal_success] offset=0 accepted
