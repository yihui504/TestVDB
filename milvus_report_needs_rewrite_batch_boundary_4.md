...
- [DEFECT: ILLEGAL_SUCCESS] searchnprobe=-1 accepted
...
if r.json().get('code') == 0: print(f'[DEFECT: ILLEGAL_SUCCESS] searchnprobe=-1 accepted'); sys.exit(1)
else: print(f'properly rejected searchnprobe=-1: {r.json()}'); sys.exit(0)
```
...
- **Initial Run**: [DEFECT: ILLEGAL_SUCCESS] searchnprobe=-1 accepted
...
Initial Evidence Excerpt: [DEFECT: ILLEGAL_SUCCESS] searchnprobe=-1 accepted
...
Reproductions:
repro_1
DB URL: http://testvdb-db-0d22f1fbe0904eaca18fbb6add3d60c9:19530
Reason: Observed explicit defect marker.
Evidence Excerpt: [defect: illegal_success] searchnprobe=-1 accepted
...
repro_2
DB URL: http://testvdb-db-1b66f2cde6b44d1dab489e293f6e8ec0:19530
Reason: Observed explicit defect marker.
Evidence Excerpt: [defect: illegal_success] searchnprobe=-1 accepted
